...
:verTypescript: ^4.3.5
:verSass: ^1.37.5
:verFontAwesome: ^0.1.15
:verAntDesign: 4.16.10
:verESLint: ^7.32.0
...
:imgSqlite: https://upload.wikimedia.org/wikipedia/commons/thumb/9/97/Sqlite-square-icon.svg/1024px-Sqlite-square-icon.svg.png
// IMG_VARIABLES_END
...
:ghSqlite: https://github.com/JoshuaWise/better-sqlite3
// GH_VARIABLES_END
...
a|image::{imgSqlite}[link={ghSqlite},50,50]
|Better SQLite3
a|[source, subs="attributes"]
----
better-sqlite3: {verSqlite}
----
|Small, fast, self-contained SQL database engine (Native Node.js Module)
