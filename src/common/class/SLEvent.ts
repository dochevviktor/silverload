...
const SLEvent = {
  ...
  LOAD_NEXT_TAB_DATE_IMAGE: new SLEventClass<SLTabImageData>(SL_REACT, SL_FILE_SYSTEM),
  LOAD_PREV_TAB_DATE_IMAGE: new SLEventClass<SLTabImageData>(SL_REACT, SL_FILE_SYSTEM),
